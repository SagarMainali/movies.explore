...
export function DetailsSection({ data, media_type }: { data: MovieAndShowsDetails, media_type: string | undefined }) {
                    ...
                    <div className="lg:w-[85%] w-[100%] flex gap-3">
                         ...
                         <div className="flex flex-col gap-4">
                              ...
                              <div className="flex gap-2 ites-center">
                                   ...
                                   {trailerMode && <VideoPopup id={data.id} setTrailerMode={setTrailerMode} />}
                              </div>
